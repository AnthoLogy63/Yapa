        ...
        {favoritos.map((receta) => (
          ...
          >
            ...
            <div className="flex flex-col justify-center bg-[#FFF8E7] relative w-[180px]">
              ...
              <button
                onClick={() => handleRemove(receta.id)}
                className="w-full h-full px-4 text-gray-800 font-medium hover:bg-orange-50 transition cursor-pointer flex flex-col items-center justify-center gap-1"
              >
                <span>Quitar de</span>
                <span>Favoritos</span>
              </button>
